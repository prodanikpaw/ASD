...
public:
    ...
    // ћетоды дл€ итераторов
    Iterator begin() { return Iterator(_head); }
    Iterator end() { return Iterator(nullptr); }
    Iterator begin() const { return Iterator(_head); }
    Iterator end() const { return Iterator(nullptr); }

    // ћетоды дл€ обратного обхода
...
// ¬ставка по позиции - O(n) в худшем случае, преимущество двусв€зности »—ѕќЋ№«”≈“—я (оптимизаци€)
template <class T>
void DLinkedList<T>::insert(int pos, const T& val) {
    ...
    if (pos == 0) {
        ...
        // ѕреимущество двусв€зного списка: начинаем с ближайшего конца
        if (pos < _count / 2) {
...
// ¬ставка перед указанным узлом - O(1), преимущество двусв€зности »—ѕќЋ№«”≈“—я
template <class T>
void DLinkedList<T>::insert(Node<T>* node, const T& val) {
    ...
    if (node == _head) {
        ...
        // ѕреимущество двусв€зного списка: не нужно искать предыдущий узел
...
// ”даление из конца - O(1), преимущество двусв€зности »—ѕќЋ№«”≈“—я (в односв€зном было O(n))
template <class T>
...
// ”даление по позиции - O(n) в худшем случае, преимущество двусв€зности »—ѕќЋ№«”≈“—я (оптимизаци€)
template <class T>
...
// ”даление указанного узла - O(1), преимущество двусв€зности »—ѕќЋ№«”≈“—я (в односв€зном было O(n))
template <class T>
